/**
 * Email Notification System - Simple Resend Implementation
 * 
 * Basic email functionality:
 * - Send form submission notifications via Resend
...
export async function sendNotification(formData, leadId) {
  ...
  if (!emailConfig.resend.apiKey) {
    throw new Error('Resend API key is required for email delivery');
  }
...
/**
 * Send email using Resend API (simple)
 */
